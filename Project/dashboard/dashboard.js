...
function renderTable() {
    ...
    for (let i = 0; i < portfolioInfo.orders.length; i++) {
        ...
        tableBodyHTML += `<tr class="order-in-table"><th>${ (datePlaced.getMonth()+1).toString().padStart(2, '0')}-${
        ...
        tableBodyHTML += `<td>${order.filled_avg_price ? "$" + round(order.filled_avg_price) : "Unfilled"}</td>`;
